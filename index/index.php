...
<body>
<header>
    <h1><img src="../fotos/Logo.png" alt="Logo" style="height: 80px;"></h1>
    <nav>
    ...
    <?php else: ?>
        <div class="conta">
            <a href="../cadastro/cadastro.html" style="text-decoration: none; color: white">Criar conta</a>
        </div>
    <?php endif; ?>
    <div>Carrinho</div>
</header>
...
<section>
        <h2 style="text-align: center; color:#e100ff ; margin: 35px; font-size: 35px; background: #ffee00 ; border: 3px solid rgb(0, 0, 0); border-radius: 30px;">Categorias</h2>
        <div>
            <div class="cat">
...
<main>
    <h3 style="margin: 90px 0px 50px 20px; font-size: 40px; font-weight: bold; color: #e100ff;">Produtos mais vendidos</h3>
    ...
    <div class="product-grid">
        ...
        <div class="product-card">
            <img src="../fotos/brinquedo1.webp" alt="Produto4" class="produto4">
            <img src="../fotos/brinquedo1.webp" alt="produto4_2" class="produto4-hover">
            <h3>Titulo</h3>
            <p>descrição</p>
        ...
        <div class="product-card">
            <img src="../fotos/brinquedo2.webp" alt="Produto5" class="produto5">
            <img src="../fotos/brinquedo2.webp" alt="produto5_2" class="produto5-hover">
            <h3>Titulo</h3>
            <p>descrição</p>
            <div class="price">R$ 99,99</div>
            <button>Adicionar ao Carrinho</button>
        ...
        <div class="product-card">
            <img src="../fotos/brinquedo3.webp" alt="Produto6" class="produto6">
            <img src="../fotos/brinquedo3.webp" alt="produto6_2" class="produto6-hover">
            <h3>Titulo</h3>
            <p>descrição</p>
            <div class="price">R$ 99,99</div>
            <button>Adicionar ao Carrinho</button>
        ...
        <div class="product-card">
            <img src="../fotos/acessorio1.webp" alt="Produto7" class="produto7">
            <img src="../fotos/acessorio1.webp" alt="produto7_2" class="produto7-hover">
            <h3>Titulo</h3>
            <p>descrição</p>
            <div class="price">R$ 99,99</div>
            <button>Adicionar ao Carrinho</button>
        ...
        <div class="product-card">
            <img src="../fotos/acessorio2.webp" alt="Produto8" class="produto8">
            <img src="../fotos/acessorio2.webp" alt="produto8_2" class="produto8-hover">
            <h3>Titulo</h3>
            <p>descrição</p>
            <div class="price">R$ 99,99</div>
            <button>Adicionar ao Carrinho</button>
        ...
        <div class="product-card">
            <img src="../fotos/acessório3.webp" alt="Produto9" class="produto9">
            <img src="../fotos/acessório3.webp" alt="produto9_2" class="produto9-hover">
            <h3>Titulo</h3>
            <p>descrição</p>
            <div class="price">R$ 99,99</div>
            <button>Adicionar ao Carrinho</button>

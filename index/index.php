...
<main>
    ...
    <div class="product-grid">
        ...
        <div class="product-card">
            ...
            <img src="../fotos/produto4_2.png" alt="produto4_2" class="produto4-hover">
            <h3>Carrinho de bonecas</h3>
            <p>Bincar brincando, vem voltar ser criança com a gente</p>
        ...
        <div class="product-card">
            ...
            <h3>Telefone de plastico</h3>
            <p>Alô mamãe. alô papai!!!</p>
            <div class="price">R$ 39,99</div>
            <button>Adicionar ao Carrinho</button>
        </div>

        <div class="product-card">
            <img src="../fotos/produto6.png" alt="Produto6" class="produto6">
            <img src="../fotos/produto6_2.png" alt="produto6_2" class="produto6-hover">
            <h3>Cavalinho de madeira</h3>
            <p>Potoque, potoque...</p>
            <div class="price">R$ 219,99</div>
            <button>Adicionar ao Carrinho</button>
        </div>
